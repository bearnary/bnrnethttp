...
func (c *defaultClient) PatchJSONWithBearerAndHeaders(url string, bearerToken string, headers *map[string]string, req interface{}, resp interface{}) (*ResponseMetadata, error) {
